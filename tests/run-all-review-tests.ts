...
const testSuites = [
  ...
  "tests/test-onboarding-wizard-step4-clarity.ts",
  ...
  "tests/test-provider-profile-query.ts",
  "tests/test-provider-session.ts",
  "tests/test-provider-dev-proxy.ts",
...
async function main() {
  ...
  console.log(
    "🚀 RUNNING ALL REVIEW & REGRESSION TEST SUITES (PROMPTS 1-4 + REPAIRS A, B, C)",
  );
  console.log(
    "================================================================\n",
  );
