...
export class SandboxProviderAdapter extends BaseProviderAdapter {
  ...
  async getProviderInfo(): Promise<ProviderInfo> {
    ...
    return {
      ...
      environment: (meta.environment as ProviderEnvironment) || ProviderEnvironment.SANDBOX,
      category: (meta.category as ProviderCategory) || ProviderCategory.PROFESSIONAL_SERVICES,
